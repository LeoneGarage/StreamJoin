...
customer_stream = (
       spark.readStream.format("cloudFiles")
          ...
          .option('cloudFiles.maxBytesPerTrigger', 8000)
          .load(customer_path)
          .drop('_rescued_data')
     )
...
transaction_stream = (
       spark.readStream.format("cloudFiles")
          ...
          .option('cloudFiles.maxBytesPerTrigger', 1600000)
...
orders_stream = (
       spark.readStream.format("cloudFiles")
          ...
          .option('cloudFiles.maxBytesPerTrigger', 800000)
          .load(orders_path)
          .drop('_rescued_data')
     )
...
products_stream = (
       spark.readStream.format("cloudFiles")
          ...
          .option('cloudFiles.maxBytesPerTrigger', 50000)
          .load(products_path)
          .drop('_rescued_data')
     )
